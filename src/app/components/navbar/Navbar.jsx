...
import { ColorModeContext } from "@/app/Theme/ThemeRegistry";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Menu Items */}
        <List sx={{ px: 3, display: "flex", flexDirection: "column", gap: 1 }}>
          {navItems.map((item, i) => (
            <motion.div
              key={item.label}
              ...
              >
                <ListItemButton
                  sx={{
                    ...
                    py: 1.5,
                    background:
                      pathname === item.href ? "rgba(255,255,255,0.12)" : "transparent",
                    "&:hover": {
